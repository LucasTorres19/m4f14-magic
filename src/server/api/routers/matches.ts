    ...
    .query(async ({ ctx, input }) => {
      ...
      const matchQuery = ctx.db
        .select({
          ...
          image: {
            id: origImage.id,
            key: origImage.fileKey,
            url: origImage.fileUrl,
            variant: origImage.variant,
            width: origImage.width,
            height: origImage.height,
            sizeBytes: origImage.sizeBytes,
            mimeType: origImage.mimeType,
          },
          croppedImage: {
            id: croppedImage.id,
            key: croppedImage.fileKey,
            url: croppedImage.fileUrl,
            variant: croppedImage.variant,
            width: croppedImage.width,
            height: croppedImage.height,
            sizeBytes: croppedImage.sizeBytes,
